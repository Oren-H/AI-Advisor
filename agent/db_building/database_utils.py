...
# Find the project root (AI-Advisor directory) and load .env from there
project_root = Path(__file__).parent.parent.parent  # Go up from db_building -> app -> AI-Advisor
...
if not api_key:
    raise ValueError(
        ...
        f"Please ensure .env file exists with OPENAI_API_KEY=your-key"
    )

def database_exists(persist_directory="./data/chroma_db"):
    """

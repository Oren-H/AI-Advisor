...
- Some information (i.e course code, credits) can be stored as metadata, meaning it doesn't get embedded but is still stored as relavent info. The only information that should get embedded is semantic info like course name and description
